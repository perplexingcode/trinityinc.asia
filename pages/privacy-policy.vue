<template>
  <div class="page">
    <div class="header">
      <div class="container">
        <p class="title">Privacy Policy for Trinity Inc</p>
      </div>
    </div>
    <div class="translations-content-container">
      <div class="container">
        <div class="tab-content translations-content-item en visible" id="en">
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                "We", "Us" or "Our" in this Agreement) refers to Trinity Inc,
                Nguyen Dinh Thi, Tay Ho.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to Trinity Inc, accessible from
                <a
                  href="trinityinc.asia"
          ...
          <ul>
            <li>By email: development@trinityinc.asia</li>
          </ul>
        </div>
      </div>
    </div>
